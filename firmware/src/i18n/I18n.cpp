...
const DefaultString DEFAULT_STRINGS[] = {
    ...
    {"perm_lock_convmgmt_body",
        "Contacts, channels and rooms become read-only on this device and for a connected companion app. Undo it by editing config.json on the SD card."},
    {"perm_lock_companion_body",
        "The Companion group is hidden from the Admin screen. Services already running keep running. Undo it by editing config.json on the SD card."},
