...
const DefaultString DEFAULT_STRINGS[] = {
    ...
    {"scope_from_repeater", "From repeater"},
    {"scope_pick_repeater", "Pick repeater"},
    ...
    {"scope_req_timeout",   "No response"},
    {"scope_none_named",    "Repeater has no named regions"},
    ...
    {"lbl_admin_lock",      "Lock Admin"},
    {"admin_lock_action",   "Lock"},
    {"admin_need_pin",      "Set an admin PIN first"},
    {"admin_locked",        "Admin locked"},
    {"admin_unlocked",      "Admin unlocked - lock is now off"},
    {"admin_lock_title",    "Lock Admin?"},
    {"admin_lock_body",
        "Admin and every settings screen will be hidden on this device. To get back in, press 0 (T-Deck) or the side button (T-Watch) and enter the admin PIN. Forget the PIN and the only way back is editing config.json on the SD card. You will be asked for the PIN next to confirm."},
    {"pin_title_admin",     "Admin PIN"},
    {"lbl_perm_settings",   "Settings Access"},
    {"lbl_perm_convmgmt",   "Manage Conversations"},
    {"lbl_perm_companion",  "Show Companion"},
    {"perm_full",           "Full"},
    {"perm_restricted",     "Restricted"},
    {"perm_none",           "Read-only"},
    {"perm_lock_title",     "Lock this device?"},
    {"perm_lock_settings_body",
        "Settings become read-only. This device cannot undo it -- you will need to edit config.json on the SD card. A connected companion app also loses the ability to change settings."},
    {"perm_lock_convmgmt_body",
        "Contacts, channels and rooms become read-only on this device and for a connected companion app. You can turn this back on here while Settings Access stays Full."},
    {"perm_lock_companion_body",
        "The Companion group is hidden from the Admin screen. Services already running keep running. You can turn this back on here while Settings Access stays Full."},
    {"perm_lock_confirm",   "Lock"},
