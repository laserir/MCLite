...
void AdminScreen::show() {
    ...
    // Messaging Settings shortcut
    {
        ...
        lv_label_set_text(dl, (String(LV_SYMBOL_LIST " ") + t("messaging_settings_title")).c_str());
        ...
        lv_obj_add_event_cb(row, [](lv_event_t* e) {
            UIManager::instance().showScreen(Screen::MESSAGING_SETTINGS);
        }, LV_EVENT_CLICKED, nullptr);
    }
